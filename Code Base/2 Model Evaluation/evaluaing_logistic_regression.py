...
from sklearn.metrics import confusion_matrix, precision_score, recall_score, accuracy_score, ConfusionMatrixDisplay, roc_curve, roc_auc_score
from sklearn import linear_model as lm,metrics  # LogisticRegression, SGDClassifier
...
acc_pred = lreg_learn(X_train,y_train,x_test)
...
print(fpr)
#skplt.metrics.plot_roc_curve(true_label, pred_label)
plt.show()
plt.show()